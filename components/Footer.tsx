    ...
    return (
        <Flex direction="column" justify="center" paddingX={10}>
            <Flex direction={mobileFooter ? "column" : "row"} justify="space-between" padding={10} gap={mobileFooter ? 10 : 4}>
                <Flex direction="column" gap={4}>
                    ...
                    <Flex gap={8}>
                        ...
                        <Link href="https://twitter.com/POKTnetwork" isExternal _hover={{ color: "poktBlue" }}>
            ...
            <HStack alignSelf="center" mb={4}>
                ...
                <Link href="https://docs.google.com/document/d/1xXMSvnh7UhrROAMkAgTgRAzzRc6C57Sr3ptoSvUqe7Q/edit?usp=sharing" isExternal _hover={{ color: "poktBlue" }}>
                    Terms of Use
                </Link>
                <Text>|</Text>
                <Link href="https://www.pokt.network/privacy-policy" isExternal _hover={{ color: "poktBlue" }}>
                    Privacy Policy
                </Link>
            </HStack>
        </Flex>
